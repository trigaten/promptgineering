...
### [Promptotype - The Platform for { structured } Prompt Engineering](https://www.promptotype.io)

> Develop, test, and monitor your LLM structured tasks. Including: 1. Extended playground with function calling, and structured outputs. 2. Manage a library of templated prompts, models, and collections of test-cases. 3. Run prompts on whole test-case collections at once. 4. Schedule automated tests. 5. Fine tuning a model based on test-case collections. -> And More!
